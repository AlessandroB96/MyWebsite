...
function Projects() {
    ...
    <article class="projects" id="projects"> 
        ...
        <section class="projects-content">
            ...
            <a target="google" href="https://alessandrob96.github.io/git-it-done/">
            <button class="btn" id="hoverbig" value="click this button to go to Git it Done">
            ...
            <a target="google" href="https://alessandrob96.github.io/PasswordGenerator/">
            <button class="btn" id="hoverbig" value="click this button to go to the password generator">
            ...
            <a target="google" href="https://alessandrob96.github.io/codequiz/">
            <button class="btn" id="hoverbig" value="click this button to go to Code Quiz">
            ...
            <a target="google" href="https://alessandrob96.github.io/WorkDayScheduler/">
            <button class="btn" id="hoverbig" value="click this button to go to the Work Day Scheduler">
            ...
            <a target="google" href="https://github.com/AlessandroB96/portfolio-generator">
            <button class="btn" id="hoverbig" value="click this button to go the portfolio generator github">
            ...
            <a target="google" href="https://github.com/AlessandroB96/READMEgenerator">
            <button class="btn" id="hoverbig" value="click this button to go to the Read Me Generator github">
            ...
            <a target="google" href="https://alessandrob96.github.io/The-Food-Conch/">
            <button class="btn" id="hoverbig" value="click this button to go to Gym Quest">
            ...
            <a target="google" href="https://hidden-caverns-61141.herokuapp.com/">
            <button class="btn"  id="hoverbig" value="click this button to go to Budget Tracker">
            ...
            <a target="google" href="https://techbloggr.herokuapp.com/">
            <button class="btn" id="hoverbig" value="click this button to go to Tech Blogger">
            ...
            <a target="google" href="https://gym-quest.herokuapp.com/">
            <button class="btn" id="hoverbig" value="click this button to go to Gym Quest">
